...
## 📋 docs/ — Основная документация (42 файла, 1.2 MB, ~404K токенов)
...
### Для NPC и AI (~10K токенов):
1. `NPC_AI_SYSTEM.md` (6.9K) → `GENERATORS_SYSTEM.md` (2.9K) → `!hotkeys.md` (2.7K NPC hotkeys)
...
├── docs/                  # Основная документация (42 файла, ~404K токенов) ← этот листинг
...
|-------|--------|-------|----------|-----|-----|-----|---------|
| `docs/` | 42 | 1.2 MB | 404K | 7 | 21 | 14 | Этот файл |
...
⚠️ Средние  (5K–15K токенов) 21 файл   ██████████████████████               50%
🔥 Дорогие  (>15K токенов)   7 файлов  ███████                               17%
```
...
*Изменения v5.0: Листинг ограничен папкой docs/, добавлены !hotkeys.md и GLOSSARY.md, BUFF_MODIFIERS_SYSTEM.md выделен как актуальный (BUFF_SYSTEM — устарело), обновлены размеры файлов, добавлены ссылки на листинги соседних папок, обновлена статистика (42 файла, 1.2 MB)*
