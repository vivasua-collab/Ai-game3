...
| **Регенерация Ци (QiRegen)** | Базовый параметр ядра (10%/сутки) | См. примечание ниже |
...
│                                                                              │
│   ПОЯСНЕНИЕ:                                                                 │
│   Базовая регенерация микроядра (10%/сутки) НЕ модифицируется.             │
│   Однако бонусы экипировки могут добавлять additive множители               │
│   к общей скорости восстановления Ци.                                       │
│   FormationBuffType.QiRegen — отдельная система для формаций.               │
│   ══════════════════════════════════════════════════════════════════════   │
│                                                                              │
