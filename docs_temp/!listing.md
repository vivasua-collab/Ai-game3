...
|---|-----------|--------|-------|----------|
| 1 | 🔴 Аудит документации | 9 | 155 KB | 51.8K |
| 2 | 🔍 Аудит кода | 13 | 374 KB | 124.8K |
| 3 | 📐 Черновики систем (в глубокой разработке) | 10 | 223 KB | 74.4K |
...
| 8 | 📌 Мета-файлы | 2 | 20 KB | 6.7K |
| | **Итого** | **57** | **1.1 MB** | **~375K** |

---

## 1. 🔴 Аудит документации (9 файлов)
...
| [!audit_compliance.md](!audit_compliance.md) | Аудит compliance документации | ⚪ Исторический | 27 KB | 9.0K | ⚠️ |
| [EQUIPMENT_SPRITES_AUDIT.md](./EQUIPMENT_SPRITES_AUDIT.md) | Аудит спрайтов экипировки | ⚪ Исторический | 10 KB | 3.5K | ✅ |
...
## 3. 📐 Черновики систем — в глубокой разработке (10 файлов)
...
| [EQUIPPED_SPRITES_DRAFT.md](./EQUIPPED_SPRITES_DRAFT.md) | Черновик экипированных спрайтов (body doll) | 🟡 В разработке | 39 KB | 13.2K | 🔥 |
| [STACKING_SYSTEM_DRAFT.md](./STACKING_SYSTEM_DRAFT.md) | Черновик системы стакинга предметов | 🟡 В разработке | 11 KB | 3.7K | ✅ |
| [TILE_SYSTEM_IMPLEMENTATION.md](./TILE_SYSTEM_IMPLEMENTATION.md) | Реализация тайловой системы (заметки) | 🟡 В разработке | 6 KB | 2.1K | ✅ |
...
## 7. 📖 Справочники и руководства (7 файлов)
...
## 8. 📌 Мета-файлы (2 файла)

| Файл | Описание | Статус | Размер | Токены ≈ | |
|------|----------|--------|--------|----------|-|
| [README.md](./README.md) | Описание папки docs_temp (устаревшее) | ⚪ Исторический | 1 KB | 0.4K | ✅ |
| [!listing.md](!listing.md) | Этот файл — каталог docs_temp/ | 🟢 Актуальный | 18 KB | 6.1K | ⚠️ |
...
*Создано: 2026-04-28*
*Редактировано: 2026-04-30 — добавлены EQUIPPED_SPRITES_DRAFT, STACKING_SYSTEM_DRAFT, !audit_compliance, EQUIPMENT_SPRITES_AUDIT, !listing.md; обновлена статистика (57 файлов, 1.1 MB)*
