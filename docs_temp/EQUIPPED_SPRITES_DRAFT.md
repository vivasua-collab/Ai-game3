...
### А3. Матрёшка v2 (восстановление системы слоёв)
...
**Вердикт:** ❌ Противоречит текущей архитектуре. Overlay-подход даёт тот же результат без изменения логики экипировки.
