...
| **Equipped** | Визуальный слой на персонаже | 1024×1024 px | Накладывается на спрайт персонажа |

> **Важно:** Для Equipped-спрайтов используется система слоёв: персонаж имеет базовый спрайт, а надетая экипировка накладывается как отдельный слой (sorting order).
