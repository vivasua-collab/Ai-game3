...
## В-13 + С-15: CultivationLevelData — формулы
...
Если BODY_SYSTEM.md описывает 5 состояний — удалить Destroyed.
Если 6 — реализовать в UpdateState().
