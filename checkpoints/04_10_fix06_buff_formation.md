...
| 2 | `Formation/FormationEffects.cs` | 495 | Control восстановление, IsAlly→через Attitude enum, заглушка BuffManager, ApplyHeal |
...
### CRITICAL
- [ ] BUF-C01: BuffManager — заменить 7 float.Parse → float.TryParse с fallback (:788,792,796,800,930,934,938)
...
- [ ] BUF-C04: FormationEffects.ApplyControlFallback — сохранять и восстанавливать оригинальные Rigidbody2D значения (Freeze/Slow/Root rollback)
...
- [ ] FRM-H02: FormationEffects.IsAlly — исправить через FactionController + новый enum **Attitude** (после Fix-04). Allied/Friendly = союзник, Hostile/Hatred = враг
- [ ] FRM-H03: FormationArrayEffect.ApplyBuff/ApplyDebuff — маршрутизировать через BuffManager вместо TODO-заглушек
...
- [ ] BUF-M05: Удалить заглушку BuffManager из FormationEffects.cs, использовать `using CultivationGame.Buff;`
- [ ] FRM-M01: FormationCore.ContributeQi — добавить проверку maxCapacity
- [ ] FRM-M02: FormationCore.practitionerId — использовать persistent ID вместо GetInstanceID()
